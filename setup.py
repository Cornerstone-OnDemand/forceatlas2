...
if USE_CYTHON:
    ...
    print(
        "Pre-generated C files are not available. This library will be slow without Cython optimizations.\n"
    )
...
setup(
    ...
    extras_require={"networkx": ["networkx>=3.0.0"], "igraph": ["python-igraph"]},
